...
class Dice:
    ...
    def apply_filter_by_contract_and_today(self):
        """Applies the 'Contract' and 'Today' filters"""
        ...
        today_filter.click()
        print('Applied Contract and Today filters')

    def apply_filter_by_contract_and_last_3_days(self):
        """Applies the 'Contract' and 'Last 3 Days' filters"""
        contract_filter = self.driver.find_element(By.XPATH, "//button[@aria-label='Filter Search Results by Contract']")
        contract_filter.click()
        ...
        print('Applied Contract and 3')

    def filterselection(self):
        if self.filter == 'today':
            self.apply_filter_by_contract_and_today()
        elif self.filter == '3':
            self.apply_filter_by_contract_and_last_3_days()
        else:
            print('Invalid filter value: ' + str(self.filter))
    ...
    def find_offers(self):
        ...
        while index < len(links):
            ...
            # Print the job title
            print(index+1, job_title, 'page no: '+int(page))
